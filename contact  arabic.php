...
<head>
	...
	<title>Contact-us | Afrizon Mall</title>
				...
				<div class="col-md-4">
					...
					<div class="Contact-Info">
						...
						<div class="tex-contact">
							<p>لا تتردد في الاتصال بنا للحصول على الدعم!</p>
						</div>
				...
				<div class="footer-columns-entry">
					<div class="row">
						<div class="col-md-3">
							...
							<div class="footer-address"><i class="fa fa-map-marker color"></i> Sudan <br> <i class="fa fa-phone color"></i> Phone: +2347017305233<br> <i class="fa fa-envelope color"></i> Email: <a href="mailto:info@swiftmart.com.ng">info@swiftmart.com.ng</a><br>
						...
						<div class="col-md-2 col-sm-4">
							<h3 class="column-title">رعاية العميل</h3>
							<ul class="column">
								<li><a href="Terms and conditions.html">الشروط والأحكام</a></li>
								<li><a href="contact.html"></a></li>اتصل</ul>
							<div class="clear"></div>
						</div>
						
						
						<div class="col-md-2 col-sm-4">
							<h3 class="column-title">معلومات المتجر</h3>
							<ul class="column">
				...
				<div class="col-md-12">
					<div class="footer-bottom-navigation">
						<div class="cell-view">
							...
							<div style="text-align: center;" class="copyright">&copy;Afrizon Group <h5> All rights reserved</h5> </div>
						</div>
					</div>
				</div>
			</div>
